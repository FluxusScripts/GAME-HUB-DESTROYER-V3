...
local window = kavoUi.CreateLib("Games HUB Destroyer V3","DarkTheme")
...
local Tab2Section = Tab2:NewSection("Games HUB Destroyer V2")
...
local Tab2Section = Tab2:NewSection("Updates disabled FIXING")
